...
Both are specialized prototypes that depend on 01.5-2's draws/[id]/page.tsx layout precedent (for the print extension) and 01.5-1's reconciliation fixture (for the strawman matrix). Wave 2 sequencing: launches after Wave 1 settles.
...
<interfaces>
<!-- Caldwell fixture imports — same set as 01.5-2/01.5-3.
...
<task type="auto">
  ...
  <read_first>
    **Aggregation reads happen in dependency order (per nwrp34 P2):** Wave 0 first → Wave 1 second → Wave 2 third. Each SUMMARY.md is consumed for its own observations; the aggregator preserves wave attribution in the findings.md output.
    ...
    - .planning/phases/stage-1.5b-prototype-gallery/stage-1.5b-prototype-gallery-2-SUMMARY.md (01.5-2 invoice/draw/vendors)
    - .planning/phases/stage-1.5b-prototype-gallery/stage-1.5b-prototype-gallery-3-SUMMARY.md (01.5-3 budget/documents)
    - .planning/phases/stage-1.5b-prototype-gallery/stage-1.5b-prototype-gallery-4-SUMMARY.md (01.5-4 owner/mobile)
    - .planning/phases/stage-1.5b-prototype-gallery/stage-1.5b-prototype-gallery-5-SUMMARY.md (01.5-5 schedule/Gantt)

    Wave 2 (read third; this plan's own summary IF available, else use working memory of Tasks 1-3):
    - .planning/phases/stage-1.5b-prototype-gallery/stage-1.5b-prototype-gallery-6-SUMMARY.md (01.5-6 print/reconciliation; if not yet written when Task 4 runs, fall back to manual aggregation from Task 1/2/3 working memory per the manual-aggregation escape clause in the action block)
...
**Rationale:** {2-3 paragraphs from 01.5-6 Task 3 summary — why this candidate visually surfaced as the obvious choice for Caldwell drift, what made other candidates less compelling}
...
|------|------|---------|---------|
| 0 | 01.5-1 | Fixture sanitization | {COMPLETE / PARTIAL with notes} |
| 1 | 01.5-2 | Invoice/draw/vendor prototypes | {COMPLETE / etc.} |
| 1 | 01.5-3 | Budget + document review | {...} |
| 1 | 01.5-4 | Owner portal + mobile approval | {...} |
| 1 | 01.5-5 | Schedule (Gantt) | {...} |
| 2 | 01.5-6 | G702/G703 print + reconciliation | {...} |

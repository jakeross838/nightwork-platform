      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {selected.size >= 2 && (
            <button
              onClick={openMerge}
              className="px-4 py-2 bg-brass hover:bg-brass/80 text-brand-bg text-sm font-medium rounded-lg transition-colors"
            >
        ...
        <div className="mb-4">
          <input
            ...
            className="w-full sm:w-80 px-4 py-2 bg-brand-surface border border-brand-border rounded-lg text-sm text-cream placeholder:text-cream-dim focus:outline-none focus:border-teal"
          />
        </div>
                      ...
                      >
                        <td className="py-4 px-4" onClick={(e) => e.stopPropagation()}>
                          <input
                            ...
                            className="w-4 h-4 rounded border-brand-border bg-brand-surface text-teal focus:ring-teal accent-teal"
                          />
                        </td>
                        <td
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-end">
                              <div className="flex-1 min-w-0">
                                ...
                                <input
                                  ...
                                  className="w-full px-3 py-2 bg-brand-surface border border-brand-border rounded-lg text-sm text-cream focus:outline-none focus:border-teal"
                                />
                              </div>
                              <div className="flex-1 min-w-0">
                              ...
                              <div className="flex gap-2">
                                <button
                                  ...
                                  disabled={saving}
                                  className="px-4 py-2 bg-teal hover:bg-teal-hover text-brand-bg text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
                                >
                                  {saving ? "Saving..." : "Save"}
                                </button>
                                <button
                                  onClick={() => setExpandedId(null)}
                                  className="px-4 py-2 bg-brand-surface hover:bg-brand-elevated text-cream-dim text-sm rounded-lg transition-colors border border-brand-border"
                                >
                                  Cancel
                                </button>
                              </div>
        ...
        {showMerge && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div className="bg-brand-card border border-brand-border rounded-2xl shadow-2xl max-w-lg w-full mx-4 p-6">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-brass hover:bg-brass/80 text-brand-bg text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
                >

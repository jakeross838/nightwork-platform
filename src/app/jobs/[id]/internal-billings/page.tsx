...
function statusBadgeClass(status: BillingStatus): string {
  switch (status) {
    ...
    case "billed":
      return "bg-slate-deep/20 text-stone-blue";
    case "paid":
  ...
  if (!job) {
    return (
      <main className="max-w-[1600px] mx-auto px-6 py-20 text-center">
        ...
        <Link
          href="/jobs"
          className="text-stone-blue hover:underline text-sm"
        >
          Back to jobs
        </Link>
      </main>
      ...
      <main className="max-w-[1600px] mx-auto px-4 md:px-6 py-8">
        ...
        {showForm && (
          <div className="border border-border-def bg-white p-4 mb-6 space-y-4">
            ...
            {formError && (
              <p className="text-xs text-nw-danger">{formError}</p>
            )}
            ...
            <div className="flex gap-2 pt-1">
              <button
                ...
                className="px-4 py-2 bg-slate-deep hover:bg-slate-deeper text-white text-sm font-medium disabled:opacity-60 transition-colors"
              >
                {saving
                  ? "Saving..."
                  : editingId
                ...
                {billings.map((b) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-right text-slate-tile tabular-nums font-display">

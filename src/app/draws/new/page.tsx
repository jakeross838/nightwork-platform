...
export default function NewDrawPage() {
 ...
 <button onClick={() => setStep(1)} className="px-6 py-2.5 border border-brand-border text-cream-muted hover:border-brand-border-light transition-colors">
 Back
 </button>
 ...
 <div className="flex justify-between">
 <button onClick={() => setStep(2)} className="px-6 py-2.5 border border-brand-border text-cream-muted hover:border-brand-border-light transition-colors">
 Back
 </button>

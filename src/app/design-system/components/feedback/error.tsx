// Design-system playground — components/feedback/error.tsx (Stage 1.5a, T20g).
//
// Error boundary for the Feedback category page. Per SPEC B10. See sibling
...
export default function ComponentsFeedbackError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error("[design-system/components/feedback] preview render failed", error);
  }, [error]);
  ...
  return (
    <div className="max-w-[640px] mx-auto py-12">
      <NwCard variant="default" padding="lg" className="text-center">
        ...
        >
          One of the Feedback primitives threw during render. Check the

// Design-system playground — components/navigation/error.tsx (Stage 1.5a, T20g).
//
// Error boundary for the Navigation category page. Per SPEC B10. See sibling
// inputs/error.tsx for the pattern + Sentry follow-up note.
...
export default function ComponentsNavigationError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error("[design-system/components/navigation] preview render failed", error);
  }, [error]);
  ...
  return (
    <div className="max-w-[640px] mx-auto py-12">
      <NwCard variant="default" padding="lg" className="text-center">
        ...
        >
          One of the Navigation primitives threw during render. Check the

// Design-system playground — components/surfaces/error.tsx (Stage 1.5a, T20g).
//
// Error boundary for the Surfaces category page. Per SPEC B10 — every
// category page in /design-system/components/<category> has its own
// error.tsx boundary. See sibling inputs/error.tsx for the pattern + Sentry
// follow-up note.
...
export default function ComponentsSurfacesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error("[design-system/components/surfaces] preview render failed", error);
  }, [error]);
  ...
  return (
    <div className="max-w-[640px] mx-auto py-12">
      <NwCard variant="default" padding="lg" className="text-center">
        ...
        >
          One of the Surfaces primitives threw during render. Check the

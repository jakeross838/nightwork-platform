// Design-system playground — components/overlays/error.tsx (Stage 1.5a, T20g).
//
// Error boundary for the Overlays category page. Per SPEC B10. See sibling
...
export default function ComponentsOverlaysError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error("[design-system/components/overlays] preview render failed", error);
  }, [error]);
  ...
  return (
    <div className="max-w-[640px] mx-auto py-12">
      <NwCard variant="default" padding="lg" className="text-center">
        ...
        >
          One of the Overlays primitives threw during render. Check the

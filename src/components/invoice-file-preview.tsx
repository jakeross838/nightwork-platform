        ...
        <div className="flex items-center justify-between border-b border-border-def bg-bg-sub px-3 py-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-1 text-[11px] px-2 py-1 border border-stone-blue text-stone-blue hover:bg-stone-blue hover:text-white transition-colors whitespace-nowrap"
            >
              Download Original
            </a>
          </div>
  ...
  return (
    <div className="border border-border-def bg-bg-sub p-6 flex flex-col items-center gap-3 text-center">
      ...
      <a
        href={downloadUrl}
        download={fileName}
        className="inline-flex items-center gap-1 text-[12px] px-3 py-1.5 border border-stone-blue text-stone-blue hover:bg-stone-blue hover:text-white transition-colors"
      >
        Download {fileName}
      </a>
    </div>

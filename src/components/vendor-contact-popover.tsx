  ...
  return (
    <span ref={ref} className="relative inline-flex items-center align-middle">
      <button
        ...
        className="inline-flex items-center justify-center w-6 h-6 rounded-full border border-[var(--border-default)] bg-[var(--bg-subtle)] text-[color:var(--text-secondary)] hover:text-[color:var(--nw-stone-blue)] hover:border-[var(--nw-stone-blue)] transition-colors"
      >
        <svg
      ...
      {open && (
        <div
          role="dialog"
          aria-label="Vendor contact info"
          className="fixed left-3 right-3 top-1/2 -translate-y-1/2 z-[90] bg-[var(--bg-card)] border border-[var(--border-default)] shadow-xl p-3 text-sm animate-fade-up sm:absolute sm:left-0 sm:right-auto sm:top-full sm:translate-y-0 sm:mt-2 sm:w-72"
        ...
        >
          ...
          {vendorId && !hasContact && (
            <p className="text-xs text-[color:var(--text-secondary)] mt-2 leading-relaxed">
              ...
              <Link
                href={editHref}
                className="text-[color:var(--nw-stone-blue)] hover:underline font-medium"
              >
                Add &rarr;
              </Link>
            </p>
            ...
            <div className="mt-2 space-y-2 text-xs">
              {vendor?.phone && (
                <a
                  ...
                  className="flex items-center gap-2 text-[color:var(--nw-stone-blue)] hover:underline"
                >
                  <svg
              ...
              {vendor?.email && (
                <a
                  ...
                  className="flex items-center gap-2 text-[color:var(--nw-stone-blue)] hover:underline break-all"
                >
                  <svg
                    className="w-3.5 h-3.5 shrink-0"
                    fill="none"
